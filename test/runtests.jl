...
@testset "PolarizedTypes.jl" begin
    ...
    @testset "Polarized Functions" begin
        ...
        @test fracpolarization(StokesParams(1.0f-5, 1.0f-5, 1.0f-6, 1.0f-7)) ≈ [1, 0.1, 0.01]
        ...
        @testset "ellipse" begin
            ...
            @test isapprox(plin.b, 0, atol = 1.0e-8)
        ...
        @testset "Complex Vis" begin
            ...
            @test evpa(real_s) ≈ evpa(complex_s) atol = 1.0e-10
        end
